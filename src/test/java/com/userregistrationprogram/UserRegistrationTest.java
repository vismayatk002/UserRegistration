...
//    }
	...
	@Test
    public void givenFirstNameWithLessThan3Exception() {
        			
		UserRegistration user = new UserRegistration();
		UserRegistrationInvalidException exception =  Assertions.assertThrows(UserRegistrationInvalidException.class, () -> {
			
			user.validateName("as");
		  });
		Assertions.assertEquals("First name should have minimum 3 letters", exception.getMessage());
    }
